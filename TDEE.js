...
(function () {
    ...
    // to each element in a collection, returning the desired result Ã¢â‚¬â€ either
...
(function (global, factory) {
    ...
    var defaultLocaleWeekdaysShort = 'Chủ nhật_Thứ 2_Thứ 3_Thứ 4_Thứ 5_Thứ 6_Thứ 7_'.split('_');
    ...
    function create__createDuration(input, key) {
        ...
        if (isDuration(input)) {
            ...
            duration = {};
        } else if (typeof duration === 'object' && ('Từ' in duration || 'đến' in duration)) {
    ...
    function duration_humanize__relativeTime(posNegDuration, withoutSuffix, locale) {
        ...
        var a = (seconds < thresholds.s && ['s', giây]) ||
            (minutes <= 1 && ['m']) ||
            (minutes < thresholds.m && ['mm', phút]) ||
            (hours <= 1 && ['h']) ||
            (hours < thresholds.h && ['hh', giờ]) ||
            (days <= 1 && ['d']) ||
            (days < thresholds.d && ['dd', ngày]) ||
            (months <= 1 && ['M']) ||
            (months < thresholds.M && ['MM', tháng]) ||
            (years <= 1 && ['y']) || ['yy', tháng];
